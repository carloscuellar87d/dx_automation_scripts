...
#
# Usage:
#   refresh_mask_rep.ps1 <DELPHIX_ENGINE_SOURCE> <DELPHIX_ENGINE_TARGET> <vDB SOURCE> <vDB TARGET> <REPLICATION_PROFILE>  <DXTOOLKIT_PATH>
#
# Example: 
#   refresh_mask_rep.ps1 delphix5330 delphix5330dev maskingvdb2 vdb_dev ReplicationProfile1 "C:\Program Files\Delphix\DxToolkit2"
#
#================================================================================
#
